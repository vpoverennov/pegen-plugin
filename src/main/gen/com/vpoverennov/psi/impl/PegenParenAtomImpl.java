...
public class PegenParenAtomImpl extends ASTWrapperPsiElement implements PegenParenAtom {

  public PegenParenAtomImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PegenVisitor visitor) {
    visitor.visitParenAtom(this);
  }
